...
<qgis version="3.32.3-Lima">
  <identifier>obec_3</identifier>
  <parentidentifier></parentidentifier>
  <language>SLK</language>
  <type>dataset</type>
  <title>Názvy katastrálnych území</title>
  <abstract>26.02.2021 - LAU1, NUTS2, NUTS3 rozšírené na 25 znakov, lebo v shp sa diakritika ráta z viac ako 1 znak.Odstránené ZBGIS_ID. Domény AUT, ACH, SOI majú prefix PUB.
1.12.2020 - doplnené atribúty NUTS.
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" type="Local Area Network" url="file://\\GKUBA198\D$\VGI\Hranice_new\11102012\hranice_oktober.mdb" format="" mimeType="" name="Personal GeoDatabase Feature Class" description=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial miny="-1336717.60306199989281595" maxx="-168541.60085700001218356" dimensions="2" minx="-588986.28067999996710569" crs="EPSG:5514" minz="0" maxy="-1139860.3432430000975728" maxz="0"/>
  </extent>
</qgis>
